...
var sharpizeImage = function (inputFilepath, outputFilepath, filename) { return __awaiter(void 0, void 0, void 0, function () {
    var sharpPromise;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                sharpPromise = new Promise(function (resolve, reject) {
                    sharp_1.default(inputFilepath)
                        .webp({ force: true })
                        .toFormat('webp')
                        .toFile(outputFilepath)
                        .then(function () {
                        console.log("Done Processing " + capitalize_1.default(filename));
                        resolve(true);
                    })
                        .catch(function (err) {
